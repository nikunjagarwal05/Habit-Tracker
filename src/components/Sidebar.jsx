        ...
        <div>
            <div className="h-[225px] w-full bg-[rgba(81,65,120,0.81)] dark:bg-[#121212] flex justify-center items-center gap-6">
                ...
                <div className="flex flex-col gap-2">
                    {/* Level Display */}
                    <div className="h-[80px] w-[166px] bg-[#675B83] hover:bg-[#5f4f84] dark:bg-[#3F3F3F] flex justify-center items-center rounded-[17px]">
                        <p className="text-[20px] text-white dark:text-white">Level:  <strong className="dark:text-[#A9A5A5]">  {level}</strong></p>
                    </div>
                ...
                <div className="h-[167px] w-[570px] bg-[#675B83] hover:bg-[#5f4f84] dark:bg-[#3F3F3F] rounded-[19px] gap-6 flex flex-col justify-center items-end pr-[20px]">
                    ...
                    <div className="flex gap-3 mt-[30px]">
                        ...
                        <div className="w-[421px]">
                            <div className="bg-[#271b3d] dark:bg-[#282828] h-[22px] rounded-full">
                                <div className="bg-[#f74e52] dark:bg-[#A9A5A5] h-[22px] rounded-full" style={{ width: `${(health / maxHealth) * 100}%` }}></div>
                            </div>
                        </div>
                    ...
                    <div className="flex gap-3">
                        ...
                        <div className="w-[421px]">
                            <div className="bg-[#271b3d]  dark:bg-[#282828] h-[22px] rounded-full">
                                <div className="bg-[#ffbe5d] dark:bg-[#A9A5A5] h-[22px] rounded-full" style={{ width: `${(experience / maxExp) * 100}%` }}></div>
                            </div>
                        </div>
                ...
                {/* Buttons Section */}
                <div className="w-[168px] h-[167px] bg-[#675B83] dark:bg-[#3A3644] rounded-[26px] flex flex-col gap-3 justify-center items-center">
                ...
                <div className="w-[400px] h-[167px] bg-[#675B83] hover:bg-[#5f4f84] rounded-[26px] flex flex-col">
