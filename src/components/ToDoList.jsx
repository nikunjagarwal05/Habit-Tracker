        ...
        <div className="h-[55px] w-[380px] m-[18px] bg-[rgba(26,24,29,0.06)]">
            <div className="flex gap-3">
                <input type="text" placeholder={placeholderText}
                        value={newTask} onChange={handleInputChange} className="outline-none hover:bg-[rgba(26,24,29,0.10)] h-[55px] focus:border-[2px] dark:focus:border-black dark:border-black border-[#514178] focus:border-[#514178] pl-[9px] text-[19px] font-medium placeholder:font-medium placeholder:text-[19px] bg-inherit w-[310px]" />
            ...
            <ol>
                {tasks.map((task, index) => 
                    <li className="flex mt-3" key={index}>
                        <button className="h-[50px] w-[60px] bg-black text-white" onClick={() => deleteTask(index)}>
                        ...
                        <button className='h-[50px] w-[60px] bg-[black] text-white'>
